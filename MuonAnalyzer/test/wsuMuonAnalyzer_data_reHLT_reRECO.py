...
process.COSMICoutput.fileName = cms.untracked.string('CosmicAnalysis_data_CosmicSP_94X_reHLT_reRECO.root')
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('CosmicMuonAnalysis_data_94X_reHLT_reRECO.root')
)

from HLTrigger.Configuration.CustomConfigs import ProcessName
process = ProcessName(process)

# Production Info ## is this relevant??
...
# Output definition  ## what is this for??
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName                     = cms.untracked.string('CosmicSP_94X_reHLT_reRECO.root'),
